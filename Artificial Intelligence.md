...
The seed is generated by averaging every training images. Then choose single neuron in network, then apply gradient ascent to 
the seed to maximize that neuron's activation value.
